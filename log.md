...
### I'M CONTINUING LOGGING WHAT I'M DOING WITH ANYTHING THAT HAS TO DO WITH MY SOFTWARE DEVELOPMENT JOURNEY WHILE I'M ON THE JOB HUNT. THIS WILL KEEP ME MOTIVATED AND LET ME REFLECT ON THE WORK THAT I'M DOING AND THINGS THAT I'M LEARNING EVERY DAY EVEN THOUGH SOMETIMES IT'S NOT VISIBLE (I.E COMMITING ON GITHUB). THERE ARE TIMES WHERE I'M WORKING ON COVER LETTERS, LOOKING FOR JOBS, OR READING TUTORIALS. THAT IS ALSO HARD WORK I'M PUTTING INTO SO THAT I CAN GET MY FIRST DEVELOPER JOB.
